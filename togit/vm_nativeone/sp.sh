...
# PEER START WITH ITS OWN IDENTITY
export CORE_PEER_MSPCONFIGPATH=~/fabric/CA/clients/$ORGANIZATION_NAME/$PEER_ID/msp
...
export CORE_PEER_PROFILE_LISTENADDRESS=$PEER_ADDRESS:6060
...
# Start Peer
#peer node start -o $ORDERER_ADDRESS:7050 2> ./$PEER_ID.log &
